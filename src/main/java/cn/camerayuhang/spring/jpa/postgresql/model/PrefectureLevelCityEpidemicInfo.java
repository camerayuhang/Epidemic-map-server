/*
 * @Author: camerayuhang
 * @Date: 2022-12-14 22:06:46
 * @LastEditors: camerayuhang
 * @LastEditTime: 2022-12-15 17:07:33
 * @FilePath: /postgresql/src/main/java/cn/camerayuhang/spring/jpa/postgresql/model/PrefectureLevelCityEpidemicInfo.java
 * @Description: 
 * 
...
@Entity
@Table(name = "prefecture_level_city_epidemic_info")
public class PrefectureLevelCityEpidemicInfo {
  @Id
  private long id;
  ...
  public PrefectureLevelCityEpidemicInfo() {
  }

  public PrefectureLevelCityEpidemicInfo(long id, long confirmed, long deaths, long recovered, long active_cases,
      long daily_new_cases, long daily_new_local_cases, long daily_new_asymptomatic, long daily_new_deaths,
      long daily_new_recovered, long daily_new_imported_cases, String province, String country, Date date, String city,
